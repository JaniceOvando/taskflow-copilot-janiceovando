...
public class TaskService {
     ...
     * (TaskOrders.POR_FECHA). Reusa la regla de vencimiento del dominio.
     */
    ...
    /**
     * Devuelve las tareas sin responsable (ReportService.SIN_ASIGNAR) ordenadas por fecha asc (POR_FECHA).
     */
